...
public class Category extends TableImpl<CategoryRecord> {
     ...
     */
    public final TableField<CategoryRecord, Boolean> CATEGORY_ID = createField(DSL.name("category_id"), SQLDataType.BOOLEAN.nullable(false).identity(true), this, "");
     ...
     */
    public final TableField<CategoryRecord, LocalDateTime> LAST_UPDATE = createField(DSL.name("last_update"), SQLDataType.LOCALDATETIME(0).nullable(false), this, "");
    ...
    @Override
    public Identity<CategoryRecord, Boolean> getIdentity() {
        return (Identity<CategoryRecord, Boolean>) super.getIdentity();
    }
