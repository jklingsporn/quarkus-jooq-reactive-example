...
public class Language extends TableImpl<LanguageRecord> {
     ...
     */
    public final TableField<LanguageRecord, Boolean> LANGUAGE_ID = createField(DSL.name("language_id"), SQLDataType.BOOLEAN.nullable(false).identity(true), this, "");
     ...
     */
    public final TableField<LanguageRecord, LocalDateTime> LAST_UPDATE = createField(DSL.name("last_update"), SQLDataType.LOCALDATETIME(0).nullable(false), this, "");
    ...
    @Override
    public Identity<LanguageRecord, Boolean> getIdentity() {
        return (Identity<LanguageRecord, Boolean>) super.getIdentity();
    }
