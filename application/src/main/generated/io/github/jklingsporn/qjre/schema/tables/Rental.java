...
public class Rental extends TableImpl<RentalRecord> {
     ...
     */
    public final TableField<RentalRecord, Boolean> STAFF_ID = createField(DSL.name("staff_id"), SQLDataType.BOOLEAN.nullable(false), this, "");

    /**
     * The column <code>sakila.rental.last_update</code>.
     */
    public final TableField<RentalRecord, LocalDateTime> LAST_UPDATE = createField(DSL.name("last_update"), SQLDataType.LOCALDATETIME(0).nullable(false), this, "");
