...
public class Inventory extends TableImpl<InventoryRecord> {
     ...
     */
    public final TableField<InventoryRecord, Boolean> STORE_ID = createField(DSL.name("store_id"), SQLDataType.BOOLEAN.nullable(false), this, "");

    /**
     * The column <code>sakila.inventory.last_update</code>.
     */
    public final TableField<InventoryRecord, LocalDateTime> LAST_UPDATE = createField(DSL.name("last_update"), SQLDataType.LOCALDATETIME(0).nullable(false), this, "");
