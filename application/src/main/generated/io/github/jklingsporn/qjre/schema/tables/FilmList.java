...
import io.github.jklingsporn.qjre.schema.tables.records.FilmListRecord;
...
public class FilmList extends TableImpl<FilmListRecord> {
     ...
     */
    public final TableField<FilmListRecord, FilmListRating> RATING = createField(DSL.name("rating"), SQLDataType.VARCHAR(5).defaultValue(DSL.inline("G", SQLDataType.VARCHAR)).asEnumDataType(io.github.jklingsporn.qjre.schema.enums.FilmListRating.class), this, "");
