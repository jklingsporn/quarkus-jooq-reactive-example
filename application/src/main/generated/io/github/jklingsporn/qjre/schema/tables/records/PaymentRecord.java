...
public class PaymentRecord extends UpdatableRecordImpl<PaymentRecord> implements VertxPojo, Record7<Short, Short, Boolean, Integer, BigDecimal, LocalDateTime, LocalDateTime>, IPayment {
     ...
     */
    @Override
    public PaymentRecord setStaffId(Boolean value) {
        set(2, value);
        return this;
    }
    ...
    @Override
    public Row7<Short, Short, Boolean, Integer, BigDecimal, LocalDateTime, LocalDateTime> valuesRow() {
    ...
    @Override
    public PaymentRecord value3(Boolean value) {
        setStaffId(value);
        return this;
    }
    ...
    @Override
    public PaymentRecord values(Short value1, Short value2, Boolean value3, Integer value4, BigDecimal value5, LocalDateTime value6, LocalDateTime value7) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public PaymentRecord(Short paymentId, Short customerId, Boolean staffId, Integer rentalId, BigDecimal amount, LocalDateTime paymentDate, LocalDateTime lastUpdate) {
        super(Payment.PAYMENT);
     ...
     * Create a detached, initialised PaymentRecord
     */
    public PaymentRecord(io.github.jklingsporn.qjre.schema.tables.pojos.Payment value) {
        super(Payment.PAYMENT);
        ...
        public PaymentRecord(io.vertx.core.json.JsonObject json) {
                this();
                fromJson(json);
        }
}
