...
import io.github.jklingsporn.qjre.schema.tables.records.NicerButSlowerFilmListRecord;
...
public class NicerButSlowerFilmList extends TableImpl<NicerButSlowerFilmListRecord> {
     ...
     */
    public final TableField<NicerButSlowerFilmListRecord, NicerButSlowerFilmListRating> RATING = createField(DSL.name("rating"), SQLDataType.VARCHAR(5).defaultValue(DSL.inline("G", SQLDataType.VARCHAR)).asEnumDataType(io.github.jklingsporn.qjre.schema.enums.NicerButSlowerFilmListRating.class), this, "");
