...
public class FilmCategory extends TableImpl<FilmCategoryRecord> {
     ...
     */
    public final TableField<FilmCategoryRecord, Boolean> CATEGORY_ID = createField(DSL.name("category_id"), SQLDataType.BOOLEAN.nullable(false), this, "");

    /**
     * The column <code>sakila.film_category.last_update</code>.
     */
    public final TableField<FilmCategoryRecord, LocalDateTime> LAST_UPDATE = createField(DSL.name("last_update"), SQLDataType.LOCALDATETIME(0).nullable(false), this, "");
