...
public class Staff extends TableImpl<StaffRecord> {
     ...
     */
    public final TableField<StaffRecord, Boolean> STAFF_ID = createField(DSL.name("staff_id"), SQLDataType.BOOLEAN.nullable(false).identity(true), this, "");
     ...
     */
    public final TableField<StaffRecord, Boolean> STORE_ID = createField(DSL.name("store_id"), SQLDataType.BOOLEAN.nullable(false), this, "");
     ...
     */
    public final TableField<StaffRecord, LocalDateTime> LAST_UPDATE = createField(DSL.name("last_update"), SQLDataType.LOCALDATETIME(0).nullable(false), this, "");
    ...
    @Override
    public Identity<StaffRecord, Boolean> getIdentity() {
        return (Identity<StaffRecord, Boolean>) super.getIdentity();
    }
