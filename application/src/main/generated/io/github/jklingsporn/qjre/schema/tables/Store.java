...
public class Store extends TableImpl<StoreRecord> {
     ...
     */
    public final TableField<StoreRecord, Boolean> STORE_ID = createField(DSL.name("store_id"), SQLDataType.BOOLEAN.nullable(false).identity(true), this, "");

    /**
     * The column <code>sakila.store.manager_staff_id</code>.
     */
    public final TableField<StoreRecord, Boolean> MANAGER_STAFF_ID = createField(DSL.name("manager_staff_id"), SQLDataType.BOOLEAN.nullable(false), this, "");
     ...
     */
    public final TableField<StoreRecord, LocalDateTime> LAST_UPDATE = createField(DSL.name("last_update"), SQLDataType.LOCALDATETIME(0).nullable(false), this, "");
    ...
    @Override
    public Identity<StoreRecord, Boolean> getIdentity() {
        return (Identity<StoreRecord, Boolean>) super.getIdentity();
    }
